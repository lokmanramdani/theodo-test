...
public class MyControllerIntegrationTests {
        ...
        private static List<Product> createProducts() {
                ...
                products.add(new Product(null, null, 30, "FLASHSALE", "Monitors", null, null,
                        null, 2, 10, LocalDate.now().minusDays(5), LocalDate.now().plusDays(10)));
                products.add(new Product(null, null, 30, "FLASHSALE", "CPUs", null, null,
                        null, 2, 10, LocalDate.now().minusDays(12), LocalDate.now().minusDays(2)));
                products.add(new Product(null, null, 30, "FLASHSALE", "CPUs", null, null,
                        null, 10, 10, LocalDate.now().minusDays(5), LocalDate.now().plusDays(10)));
                return products;
        }
}
